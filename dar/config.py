...
# أسعار البرامج (نوع الدراسة): (سعر ساعة الطالب، سعر ساعة المحفظ)
# سعر ساعة المحفظ None يعني: يُؤخذ من ملف المحفظين (مثال قرآن: 35 للجميع و40 لبثينة).
# كلها قابلة للتعديل لكل تسجيل على حدة من شاشة التسجيلات.
PROGRAM_RATES = {
    "قرآن":                    (65, None),
    "نور البيان":              (70, 50),
...
# فروع الدار (للاختيار عند تسجيل الطالب)
BRANCHES = [
